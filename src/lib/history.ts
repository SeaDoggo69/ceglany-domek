  ...
  pl: {
    ...
    sections: [
      ...
      },
      {
        ...
        image: "/images/historic/historic-palace-interior.webp",
        imageAlt: "Wnętrze pałacu myśliwskiego w Griesel - sala jadalna z trofeami, gdzie spędzała wakacje rodzina Margarete",
      },
      {
        eyebrow: "Vordermühle",
        title: "Pierwszy Młyn",
      ...
      },
      {
        ...
        image: "/images/historic/community-event-2014.webp",
        imageAlt: "Współcześni mieszkańcy Gryżyny podczas wioskowej uroczystości - dzieci i rekonstrukcja historyczna",
      },
      {
        eyebrow: "Dziś",
        ...
        imageAlt: "Złota dębowa aleja w Gryżyńskim Parku Krajobrazowym jesienią - dziedzictwo Krausego z 1840 r.",
      },
    ],
    ...
    archiveGallery: {
      ...
      images: [
        ...
        {
          src: "/images/historic/historic-palace.webp",
          caption: "Pałac myśliwski (Jagdschloß) w Griesel - przedwojenna pocztówka",
        },
        {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        image: "/images/historic/historic-palace-interior.webp",
        imageAlt: "Interior of the hunting palace in Griesel - dining room with hunting trophies where Margarete's family spent their holidays",
      },
      {
        eyebrow: "Vordermühle",
      ...
      },
      {
        ...
        image: "/images/historic/community-event-2014.webp",
        imageAlt: "Today's Gryżyna residents during a village event - children and a historical re-enactment",
      },
      {
        eyebrow: "Today",
        ...
        image: "/images/historic/oak-alley-autumn-2005.webp",
        imageAlt: "Golden oak alley in Gryżyna Landscape Park in autumn - the 1840 legacy of Krause",
      },
    ],
    ...
    archiveGallery: {
      ...
      images: [
        ...
        {
          src: "/images/historic/historic-palace.webp",
          caption: "The hunting palace (Jagdschloß) in Griesel - pre-war postcard",
        },
        {
          src: "/images/historic/historic-mill-vordermuhle.webp",
